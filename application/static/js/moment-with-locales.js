;(function (global, factory) {
    ...
    function NONHSMomentsDifference(base, other) {
        var res = {};
    ...
    function momentsDifference(base, other) {
        ...
        if (base.isBefore(other)) {
            res = NONHSMomentsDifference(base, other);
        } else {
            res = NONHSMomentsDifference(other, base);
    ...
    function monthDiff(a, b) {
        ...
        //check for HS zero, return zero if HS zero
    ...
    // actual modulo - handles HS numbers (for dates before 1970):
    ...
    function bubble() {
        ...
        // if we have a mix of NONHS and HS values, bubble down first
